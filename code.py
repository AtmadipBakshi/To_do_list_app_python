...
retrieveb = tk.Button(root, text="Add", fg='black', bg="yellow", command=add_task, font=('Arial', 14, 'bold'), height=1,
                      width=6)
retrieveb.place(x=215, y=70)

delete_button = tk.Button(root, text="Delete", fg='black', bg="yellow", command=delete_selected,
                          font=('Arial', 14, 'bold'), height=1, width=6)
delete_button.place(x=150, y=350)

exit_button = tk.Button(root, text="Exit", fg='black', bg="yellow", command=exitb, font=('Arial', 14, 'bold'), height=1,
                        width=6)
